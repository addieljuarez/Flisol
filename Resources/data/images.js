getImage = function(icon) {
	...
	if(!i.exists()) {
		...
		Ti.API.info('Fetching http://www.dimsatec.com/services/flisol/img/'+icon);
		// create an image view to hold our remote icon
		var tmpImage = Ti.UI.createImageView({
			image: 'http://www.dimsatec.com/services/flisol/img/'+icon
		});
		...
		return 'http://www.dimsatec.com/services/flisol/img/'+icon;
	} else {
